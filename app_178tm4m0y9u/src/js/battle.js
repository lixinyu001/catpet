  ...
  if (category === 'single_atk' || category === 'aoe_atk' || category === 'single_cc' || category === 'aoe_cc') {
    ...
    targetPets.forEach(function(tp) {
      if (liveBattle.petHp[tp.id].current <= 0) {
        ...
        if (!revived && tBloodline2 && tBloodline2.effects && tBloodline2.effects.reviveChance && Math.random() < tBloodline2.effects.reviveChance) {
...
function applyTurnRegen() {
  ...
  liveBattle.team.forEach(pet => {
    ...
    if (hp.current <= 0) {
      ...
      if (!dotRevived && bloodline && bloodline.effects && bloodline.effects.reviveChance && Math.random() < bloodline.effects.reviveChance) {
