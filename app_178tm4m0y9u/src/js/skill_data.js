...
const ACTIVE_SKILLS = [
  ...
  // ===== 群体攻击 =====
  { id: 'meteor', name: '陨石天降', type: 'active', category: 'aoe_atk', desc: '【物理·群体·秒3】对3个目标造成 72% 攻击力的火焰伤害。\n每目标伤害：攻击力×0.72×技能加成 − 目标防御×0.7（±10%波动）。\n基础暴击率10%。', element: '火', dmgPct: 0.72, cd: 0, target: 'enemy_all', targetCount: 3 },
  { id: 'blizzard', name: '暴风雪', type: 'active', category: 'aoe_atk', desc: '【法术·群体·秒4·控制】对4个目标造成 48% 灵力的冰系伤害，20%概率冻结1回合。\n伤害公式：灵力×0.48×技能加成 − 目标防御×0.7。\n冻结：无法行动。', element: '冰', dmgPct: 0.48, cd: 0, target: 'enemy_all', targetCount: 4, freezeChance: 0.20, freezeTurns: 1 },
  { id: 'lightning_chain', name: '闪电链', type: 'active', category: 'aoe_atk', desc: '【法术·全体】对全体敌人造成 88% 灵力的雷系伤害。\n伤害公式：灵力×0.88×技能加成 − 目标防御×0.7（±10%波动）。\n基础暴击率10%。', element: '雷', dmgPct: 0.88, cd: 0, target: 'enemy_all' },
  { id: 'shadow_burst', name: '暗影爆发', type: 'active', category: 'aoe_atk', desc: '【法术·全体·吸血】对全体敌人造成 80% 灵力的暗影伤害，吸血10%。\n伤害公式：灵力×0.80×技能加成 − 目标防御×0.7。\n回复量 = 总伤害×10%。', element: '暗', dmgPct: 0.80, cd: 0, target: 'enemy_all', vampPct: 0.10 },
  { id: 'flame_storm', name: '烈焰风暴', type: 'active', category: 'aoe_atk', desc: '【物理·群体·秒3·持续】对3个目标造成 76.5% 攻击力的火焰伤害，附加燃烧2回合。\n伤害公式：攻击力×0.765×技能加成 − 目标防御×0.7。\n燃烧：每回合损失5%最大气血。', element: '火', dmgPct: 0.765, cd: 0, target: 'enemy_all', targetCount: 3, burnTurns: 2, burnPct: 0.05 },
  { id: 'poison_mist', name: '毒雾', type: 'active', category: 'aoe_atk', desc: '【法术·群体·秒4·持续】对4个目标造成 40% 灵力的毒系伤害，全体中毒3回合。\n伤害公式：灵力×0.40×技能加成 − 目标防御×0.7。\n中毒：每回合损失5%最大气血。', element: '毒', dmgPct: 0.40, cd: 0, target: 'enemy_all', targetCount: 4, poisonTurns: 3, poisonPct: 0.05 },
  { id: 'earth_crack', name: '地裂术', type: 'active', category: 'aoe_atk', desc: '【物理·全体·控制】对全体敌人造成 135% 攻击力的伤害，30%概率眩晕1回合。\n伤害公式：攻击力×1.35×技能加成 − 目标防御×0.7。', element: '无', dmgPct: 1.35, cd: 0, target: 'enemy_all', stunChance: 0.30, stunTurns: 1 },
  // ===== 单体治疗 =====
  ...
  // ===== 群体控制 =====
  { id: 'mass_freeze', name: '群体冰冻', type: 'active', category: 'aoe_cc', desc: '【法术·全体·控制】对全体敌人造成 48% 灵力的冰系伤害，30%概率冻结1回合。\n伤害公式：灵力×0.48×技能加成 − 目标防御×0.7。', element: '冰', dmgPct: 0.48, cd: 0, target: 'enemy_all', freezeChance: 0.30, freezeTurns: 1 },
  { id: 'earthquake', name: '地震术', type: 'active', category: 'aoe_cc', desc: '【物理·全体·控制】对全体敌人造成 63% 攻击力的伤害，25%概率眩晕1回合。\n伤害公式：攻击力×0.63×技能加成 − 目标防御×0.7。', element: '无', dmgPct: 0.63, cd: 0, target: 'enemy_all', stunChance: 0.25, stunTurns: 1 },
  { id: 'hypnosis', name: '催眠术', type: 'active', category: 'aoe_cc', desc: '【法术·全体·控制】对全体敌人造成 32% 灵力的暗影伤害，20%概率睡眠1回合。\n伤害公式：灵力×0.32×技能加成 − 目标防御×0.7。\n睡眠：无法行动，受到攻击会醒来。', element: '暗', dmgPct: 0.32, cd: 0, target: 'enemy_all', sleepChance: 0.20, sleepTurns: 1 },
  // ===== 单体辅助 =====
  ...
  // ===== 参考长安幻想主动技能 =====
  { id: 'flame_charge', name: '烈焰冲撞', type: 'active', category: 'aoe_atk', desc: '【物理·群体】对2个目标造成 108% 攻击力的火焰伤害。\n每目标伤害：攻击力×1.08×技能加成 − 目标防御×0.7（±10%波动）。', element: '火', dmgPct: 1.08, cd: 0, target: 'enemy_all' },
  { id: 'thunder_spell', name: '奔雷咒', type: 'active', category: 'aoe_atk', desc: '【法术·全体】对全体敌人造成 100% 灵力的雷系伤害。\n伤害公式：灵力×1.00×技能加成 − 目标防御×0.7（±10%波动）。', element: '雷', dmgPct: 1.00, cd: 0, target: 'enemy_all' },
  { id: 'water_deluge', name: '碧水滔天', type: 'active', category: 'aoe_atk', desc: '【物理·群体·秒4】对4个目标造成 49.5% 攻击力的水系伤害，附带减速效果。\n伤害公式：攻击力×0.495×技能加成 − 目标防御×0.7。', element: '水', dmgPct: 0.495, cd: 0, target: 'enemy_all', targetCount: 4 },
  { id: 'mountain_crush', name: '泰山压顶', type: 'active', category: 'aoe_cc', desc: '【物理·全体·控制】对全体敌人造成 121.5% 攻击力的土系伤害，25%概率眩晕1回合。\n伤害公式：攻击力×1.215×技能加成 − 目标防御×0.7。', element: '土', dmgPct: 1.215, cd: 0, target: 'enemy_all', stunChance: 0.25, stunTurns: 1 },
  ...
  { id: 'soul_search', name: '搜魂斩', type: 'active', category: 'aoe_atk', desc: '【物理·群体】横扫3个目标，每个造成 81% 攻击力的物理伤害。\n每目标伤害：攻击力×0.81×技能加成 − 目标防御×0.7。', element: '无', dmgPct: 0.81, cd: 0, target: 'enemy_all' },
  ...
  { id: 'butterfly_tide', name: '蝶潮', type: 'active', category: 'aoe_cc', desc: '【法术·群体·秒5·控制】对5个目标造成 36% 灵力的暗影伤害，20%概率附加梦魇（睡眠）1回合。\n伤害公式：灵力×0.36×技能加成 − 目标防御×0.7。', element: '暗', dmgPct: 0.36, cd: 0, target: 'enemy_all', targetCount: 5, sleepChance: 0.20, sleepTurns: 1 },
  ...
  { id: 'buddha_quake', name: '佛行震地', type: 'active', category: 'aoe_atk', desc: '【法术·群体·秒5·治疗】对5个目标造成 40% 灵力的光系伤害，并回复生命最低友方20%最大气血。\n伤害公式：灵力×0.40×技能加成 − 目标防御×0.7。', element: '光', dmgPct: 0.40, cd: 0, target: 'enemy_all', targetCount: 5, postHealPct: 0.20, postHealTarget: 'lowest' },
  // ===== 融合限定特殊宠物独有主动技能 =====
  { id: 'chaos_strike', name: '混元一击', type: 'active', category: 'aoe_atk', desc: '【物理·全体·融合限定】混元之力对全体敌人造成 180% 攻击力的伤害，并回复全队30%最大气血。\n伤害公式：攻击力×1.80×技能加成 − 目标防御×0.7。\n治疗量 = 各友方最大气血×30%。', element: '混沌', dmgPct: 1.80, cd: 0, target: 'enemy_all', postHealPct: 0.30, postHealTarget: 'team' },
  { id: 'doom_inferno', name: '灭世之炎', type: 'active', category: 'aoe_cc', desc: '【物理·全体·融合限定】对全体敌人造成 198% 攻击力的火焰伤害，50%概率附加灼烧3回合。\n伤害公式：攻击力×1.98×技能加成 − 目标防御×0.7。\n灼烧：每回合损失5%最大气血。', element: '火', dmgPct: 1.98, cd: 0, target: 'enemy_all', burnChance: 0.50, burnTurns: 3 },
  ...
  // 多段群体伤害
  { id: 'thunderous_might', name: '雷霆万钧', type: 'active', category: 'aoe_atk', desc: '【法术·群体·3连击】对全体敌人连续3次雷系伤害，每次44%灵力。\n每击伤害：灵力×0.44×技能加成 − 目标防御×0.7（每击独立判定暴击）。', element: '雷', dmgPct: 0.44, cd: 0, target: 'enemy_all', hits: 3 },
  // 反击状态：受击时反击
  ...
  { id: 'arcane_burst', name: '奥术爆发', type: 'active', category: 'aoe_atk', quality: 'epic',
    desc: '【魔法·群体·秒3】伤害 = 自身魔法值 × 64%，对3个目标造成奥术伤害。\n每目标伤害：自身魔法值×0.64×技能加成 − 目标防御×0.7。\n魔法越高，伤害越强。基础暴击率10%。',
    element: '奥术', dmgPct: 0.64, powerAttr: 'mp', cd: 0, target: 'enemy_all', targetCount: 3 },
  // 防御决定伤害的技能
  ...
  { id: 'blood_pool_burst', name: '血池爆裂', type: 'active', category: 'aoe_atk', quality: 'epic',
    desc: '【血量·群体·秒4】伤害 = 自身气血 × 27%，对4个目标造成血系伤害。\n每目标伤害：自身当前气血×0.27×技能加成 − 目标防御×0.7。\n气血越高，伤害越强。基础暴击率10%。',
    element: '无', dmgPct: 0.27, powerAttr: 'hp', cd: 0, target: 'enemy_all', targetCount: 4 },
  ...
  { id: 'life_torrent', name: '生命洪流', type: 'active', category: 'aoe_atk', quality: 'legend',
    desc: '【血量差·群体·秒3】伤害 = (自身气血 − 目标气血) × 31.5%，对3个目标造成伤害。\n每目标伤害：(自身气血−目标气血)×0.315×技能加成 − 目标防御×0.7。\n气血差越大，伤害越高。基础暴击率10%。',
    element: '无', dmgPct: 0.315, powerAttr: 'hpDiff', cd: 0, target: 'enemy_all', targetCount: 3 },
  ...
  { id: 'arcane_barrage', name: '魔能弹幕', type: 'active', category: 'aoe_atk', quality: 'legend',
    desc: '【魔法·群体·秒5】伤害 = 自身魔法值 × 48%，对5个目标造成奥术伤害。\n每目标伤害：自身魔法值×0.48×技能加成 − 目标防御×0.7。\n魔法越高，伤害越强。基础暴击率10%。',
    element: '奥术', dmgPct: 0.48, powerAttr: 'mp', cd: 0, target: 'enemy_all', targetCount: 5 },
  ...
  { id: 'mana_storm', name: '法力风暴', type: 'active', category: 'aoe_atk', quality: 'legend',
    desc: '【魔法·全体】伤害 = 自身魔法值 × 40%，对全体敌人造成奥术伤害。\n伤害公式：自身魔法值×0.40×技能加成 − 目标防御×0.7。\n魔法越高，伤害越强。基础暴击率10%。',
    element: '奥术', dmgPct: 0.40, powerAttr: 'mp', cd: 0, target: 'enemy_all' },
  ...
  { id: 'guardian_wrath', name: '守护之怒', type: 'active', category: 'aoe_atk', quality: 'legend',
    desc: '【防御·群体·秒4·嘲讽】伤害 = 自身防御力 × 180%，对4个目标造成伤害并全体嘲讽1回合。\n每目标伤害：自身防御力×1.80×技能加成 − 目标防御×0.7。\n嘲讽：敌人只能攻击施法者。基础暴击率10%。',
    element: '无', dmgPct: 1.80, powerAttr: 'def', cd: 0, target: 'enemy_all', targetCount: 4, tauntTurns: 1 },
  ...
  { id: 'lightning_raid', name: '闪电突袭', type: 'active', category: 'aoe_atk', quality: 'epic',
    desc: '【速度·群体·秒3】伤害 = 自身速度 × 180%，对3个目标造成雷电伤害，20%概率眩晕1回合。\n每目标伤害：自身速度×1.80×技能加成 − 目标防御×0.7。\n速度越高，伤害越强。基础暴击率10%。',
    element: '雷', dmgPct: 1.80, powerAttr: 'spd', cd: 0, target: 'enemy_all', targetCount: 3, stunChance: 0.20, stunTurns: 1 },
  ...
  { id: 'shadow_clone', name: '影分身', type: 'active', category: 'aoe_atk', quality: 'legend',
    desc: '【速度·群体·秒4·必中】伤害 = 自身速度 × 225%，对4个目标造成伤害，必定命中。\n每目标伤害：自身速度×2.25×技能加成 − 目标防御×0.7。\n速度越高，伤害越强。基础暴击率10%。',
    element: '暗', dmgPct: 2.25, powerAttr: 'spd', cd: 0, target: 'enemy_all', targetCount: 4, alwaysHit: true },
...
const FORMATION_ESCORT = {
  ...
  desc: '护送镖车安全抵达目的地，每击败一波拦路怪物获得1本阵法书，全部完成可获得额外金币奖励（等级×50）',
};
...
const SKILL_BOOK_HUNT = {
  ...
  dailyLimit: 3,
  maxStages: 5,
  desc: '挑战技能秘境多层关卡，难度逐层提升但奖励也越发丰厚。每击败一波怪物获得技能书，失败可保留已获奖励！',
  // 各阶段怪物强度倍率和奖励倍率
  stageConfig: [
