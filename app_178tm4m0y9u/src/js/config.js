...
const PET_DEX = {
  ...
  '龙渊帝君': { race:'龙', aptRange:{力量资质:[3000,3000],体质资质:[3000,3000],敏捷资质:[3000,3000],智力资质:[3000,3000]}, growthRange:[3.0,3.0], specialty:'balanced', innateSkills:['holy_radiance','fatal_blow','aura_atk_3'], desc:'【神兽】龙族至高帝君，掌控龙渊之力，万龙之主', isDivineBeast: true, forceTier: 6 },
  '太古原核': { race:'史莱姆', aptRange:{力量资质:[3000,3000],体质资质:[3000,3000],敏捷资质:[3000,3000],智力资质:[3000,3000]}, growthRange:[3.0,3.0], specialty:'defense', innateSkills:['iron_wall','regen_2','aura_hp_3'], desc:'【神兽】史莱姆始祖，万物原初之核，不灭不朽', isDivineBeast: true, forceTier: 6 },
  '万影至尊': { race:'哥布林', aptRange:{力量资质:[3000,3000],体质资质:[3000,3000],敏捷资质:[3000,3000],智力资质:[3000,3000]}, growthRange:[3.0,3.0], specialty:'speed', innateSkills:['sneak_atk_2','dodge_2','aura_spd_3'], desc:'【神兽】哥布林至高影王，统御万影，来去无踪', isDivineBeast: true, forceTier: 6 },
  '炽天神将': { race:'天使', aptRange:{力量资质:[3000,3000],体质资质:[3000,3000],敏捷资质:[3000,3000],智力资质:[3000,3000]}, growthRange:[3.0,3.0], specialty:'balanced', innateSkills:['holy_radiance','blessing','aura_def_3'], desc:'【神兽】天使至高神将，炽天之光，守护苍生', isDivineBeast: true, forceTier: 6 },
  '万木灵尊': { race:'精灵', aptRange:{力量资质:[3000,3000],体质资质:[3000,3000],敏捷资质:[3000,3000],智力资质:[3000,3000]}, growthRange:[3.0,3.0], specialty:'magic', innateSkills:['life_bloom','heal_wind','aura_regen_3'], desc:'【神兽】精灵万木之灵，生命与自然之主', isDivineBeast: true, forceTier: 6 },
  '深渊魔神': { race:'恶魔', aptRange:{力量资质:[3000,3000],体质资质:[3000,3000],敏捷资质:[3000,3000],智力资质:[3000,3000]}, growthRange:[3.0,3.0], specialty:'physical', innateSkills:['doom_judge','meteor','berserk'], desc:'【神兽】恶魔深渊之主，吞噬万物的魔神', isDivineBeast: true, forceTier: 6 },
  // ===== 扩展宠物（T1~T5 共 100 种） =====
  ...
  '星光雏': { race:'天使', aptRange:{力量资质:[1000,1400],体质资质:[1000,1400],敏捷资质:[1200,1800],智力资质:[1100,1500]}, growthRange:[0.7,1.3], specialty:'speed', innateSkills:['dodge'], desc:'星光孕育的幼鸟，可进阶为星光战鹰', evolvable: true, evolveType: 'T1', evolveChain: ['星光雏','星光战鹰','星光神鹰'] },
  '烈焰幼龙': { race:'龙', aptRange:{力量资质:[1200,1800],体质资质:[1000,1400],敏捷资质:[1000,1400],智力资质:[900,1300]}, growthRange:[0.8,1.3], specialty:'physical', innateSkills:['flame_strike'], desc:'烈焰中诞生的幼龙，可进阶为烈焰飞龙', evolvable: true, evolveType: 'T1', evolveChain: ['烈焰幼龙','烈焰飞龙','烈焰龙王'] },
  '寒冰幼龟': { race:'史莱姆', aptRange:{力量资质:[1000,1400],体质资质:[1400,1800],敏捷资质:[600,1000],智力资质:[1000,1400]}, growthRange:[0.7,1.3], specialty:'defense', innateSkills:['def_up'], desc:'寒冰覆盖的幼龟，可进阶为寒冰玄龟', evolvable: true, evolveType: 'T1', evolveChain: ['寒冰幼龟','寒冰玄龟','寒冰龙龟'] },
  '暗影幼狐': { race:'精灵', aptRange:{力量资质:[1000,1400],体质资质:[900,1300],敏捷资质:[1300,1800],智力资质:[1100,1500]}, growthRange:[0.8,1.3], specialty:'speed', innateSkills:['sneak_atk'], desc:'暗影中的幼狐，可进阶为暗影灵狐', evolvable: true, evolveType: 'T1', evolveChain: ['暗影幼狐','暗影灵狐','暗影九尾'] },
  '雷霆幼豹': { race:'哥布林', aptRange:{力量资质:[1100,1500],体质资质:[900,1300],敏捷资质:[1300,1800],智力资质:[1000,1400]}, growthRange:[0.8,1.3], specialty:'speed', innateSkills:['speed_up'], desc:'雷霆缠绕的幼豹，可进阶为雷霆猎豹', evolvable: true, evolveType: 'T1', evolveChain: ['雷霆幼豹','雷霆猎豹','雷霆神豹'] },
  '圣光幼灵': { race:'天使', aptRange:{力量资质:[900,1300],体质资质:[1000,1400],敏捷资质:[1000,1400],智力资质:[1300,1800]}, growthRange:[0.8,1.3], specialty:'magic', innateSkills:['cure'], desc:'圣光眷顾的幼灵，可进阶为圣光使者', evolvable: true, evolveType: 'T1', evolveChain: ['圣光幼灵','圣光使者','圣光大天使'] },
  '翠叶幼精': { race:'精灵', aptRange:{力量资质:[900,1300],体质资质:[1000,1400],敏捷资质:[1000,1400],智力资质:[1300,1800]}, growthRange:[0.7,1.3], specialty:'magic', innateSkills:['life_bloom'], desc:'翠叶间的幼小精灵，可进阶为翠叶花灵', evolvable: true, evolveType: 'T1', evolveChain: ['翠叶幼精','翠叶花灵','翠叶树神'] },
  '铁甲幼蟹': { race:'史莱姆', aptRange:{力量资质:[1100,1500],体质资质:[1400,1800],敏捷资质:[700,1100],智力资质:[900,1300]}, growthRange:[0.7,1.3], specialty:'defense', innateSkills:['guard_shield'], desc:'铁甲护身的幼蟹，可进阶为铁甲巨蟹', evolvable: true, evolveType: 'T1', evolveChain: ['铁甲幼蟹','铁甲巨蟹','铁甲蟹皇'] },
  '噬魂幼蝠': { race:'恶魔', aptRange:{力量资质:[1100,1500],体质资质:[900,1300],敏捷资质:[1300,1800],智力资质:[1100,1500]}, growthRange:[0.8,1.3], specialty:'speed', innateSkills:['shadow_strike'], desc:'噬魂的幼蝠，可进阶为噬魂夜蝠', evolvable: true, evolveType: 'T1', evolveChain: ['噬魂幼蝠','噬魂夜蝠','噬魂魔王'] },
  '赤焰幼狮': { race:'哥布林', aptRange:{力量资质:[1300,1800],体质资质:[1000,1400],敏捷资质:[1000,1400],智力资质:[900,1300]}, growthRange:[0.8,1.3], specialty:'physical', innateSkills:['power_up'], desc:'赤焰中的幼狮，可进阶为赤焰战狮', evolvable: true, evolveType: 'T1', evolveChain: ['赤焰幼狮','赤焰战狮','赤焰狮王'] },
  '冰晶幼鹿': { race:'精灵', aptRange:{力量资质:[900,1300],体质资质:[1000,1400],敏捷资质:[1100,1500],智力资质:[1300,1800]}, growthRange:[0.8,1.3], specialty:'magic', innateSkills:['ice_arrow'], desc:'冰晶凝聚的幼鹿，可进阶为冰晶灵鹿', evolvable: true, evolveType: 'T1', evolveChain: ['冰晶幼鹿','冰晶灵鹿','冰晶神鹿'] },
  '玄铁幼犀': { race:'史莱姆', aptRange:{力量资质:[1300,1800],体质资质:[1500,1800],敏捷资质:[600,1000],智力资质:[800,1200]}, growthRange:[0.7,1.3], specialty:'defense', innateSkills:['parry'], desc:'玄铁般的幼犀，可进阶为玄铁甲犀', evolvable: true, evolveType: 'T1', evolveChain: ['玄铁幼犀','玄铁甲犀','玄铁巨犀'] },
  // ---- T3可进阶宠物（8只）：资质上限2300，成长同普通T3，可进阶一次 T3→T5 ----
  '烈焰战虎': { race:'哥布林', aptRange:{力量资质:[1800,2300],体质资质:[1500,1900],敏捷资质:[1400,1800],智力资质:[1100,1500]}, growthRange:[1.5,2.2], specialty:'physical', innateSkills:['flame_strike','fatal_blow'], desc:'烈焰环绕的战虎，可进阶为烈焰虎神', evolvable: true, evolveType: 'T3', evolveChain: ['烈焰战虎','烈焰虎神'] },
  '冰霜法师': { race:'恶魔', aptRange:{力量资质:[1100,1500],体质资质:[1200,1600],敏捷资质:[1200,1600],智力资质:[1800,2300]}, growthRange:[1.5,2.2], specialty:'magic', innateSkills:['blizzard','freeze'], desc:'掌控冰霜的法师，可进阶为冰霜大法师', evolvable: true, evolveType: 'T3', evolveChain: ['冰霜法师','冰霜大法师'] },
  '暗影潜行者': { race:'精灵', aptRange:{力量资质:[1500,1900],体质资质:[1000,1400],敏捷资质:[1800,2300],智力资质:[1300,1700]}, growthRange:[1.5,2.2], specialty:'speed', innateSkills:['sneak_atk_2','dodge_2'], desc:'暗影中的潜行者，可进阶为暗影影王', evolvable: true, evolveType: 'T3', evolveChain: ['暗影潜行者','暗影影王'] },
  '圣盾守卫': { race:'史莱姆', aptRange:{力量资质:[1500,1900],体质资质:[2000,2300],敏捷资质:[800,1200],智力资质:[1100,1500]}, growthRange:[1.4,2.2], specialty:'defense', innateSkills:['iron_wall','guard_shield'], desc:'持圣盾的守卫，可进阶为圣盾骑士', evolvable: true, evolveType: 'T3', evolveChain: ['圣盾守卫','圣盾骑士'] },
  '雷电游侠': { race:'天使', aptRange:{力量资质:[1400,1800],体质资质:[1000,1400],敏捷资质:[1800,2300],智力资质:[1300,1700]}, growthRange:[1.5,2.2], specialty:'speed', innateSkills:['thunder_strike','stun_strike'], desc:'雷电缠绕的游侠，可进阶为雷电神射手', evolvable: true, evolveType: 'T3', evolveChain: ['雷电游侠','雷电神射手'] },
  '翡翠术士': { race:'精灵', aptRange:{力量资质:[1100,1500],体质资质:[1200,1600],敏捷资质:[1400,1800],智力资质:[1900,2300]}, growthRange:[1.5,2.2], specialty:'magic', innateSkills:['magic_double_2','aura_hp'], desc:'翡翠之力的术士，可进阶为翡翠大术士', evolvable: true, evolveType: 'T3', evolveChain: ['翡翠术士','翡翠大术士'] },
  '深渊猎手': { race:'恶魔', aptRange:{力量资质:[1900,2300],体质资质:[1500,1900],敏捷资质:[1500,1900],智力资质:[1200,1600]}, growthRange:[1.5,2.2], specialty:'physical', innateSkills:['blood_drain','fatal_blow'], desc:'深渊中的猎手，可进阶为深渊猎神', evolvable: true, evolveType: 'T3', evolveChain: ['深渊猎手','深渊猎神'] },
  '苍穹武僧': { race:'天使', aptRange:{力量资质:[1700,2100],体质资质:[1600,2000],敏捷资质:[1500,1900],智力资质:[1500,1900]}, growthRange:[1.5,2.2], specialty:'balanced', innateSkills:['double_slash','def_up_2'], desc:'苍穹下的武僧，可进阶为苍穹武神', evolvable: true, evolveType: 'T3', evolveChain: ['苍穹武僧','苍穹武神'] },
};
...
function calcSamsaraPoints(floor) {
  ...
  return Math.floor(SAMSARA_POINT_BASE * Math.pow(SAMSARA_POINT_GROWTH, floor - SAMSARA_REBIRTH_MIN_FLOOR) * (floor - SAMSARA_REBIRTH_MIN_FLOOR + 1));
}
...
function getDivinePowerEffect(powerId) {
  ...
  var multiplier = Math.pow(2, star - 1); // 1星=×1, 2星=×2, 3星=×4...
  return {
    id: def.id,
    name: def.name,
    icon: def.icon,
...
function generateChestContents(rarity) {
  ...
  // 需求4：主线掉落去除打孔钉/修补胶/宝石（这些只能通过活动/商城/打宝图获取）
  var pools = {
    white: [
...
var DUNGEON_DROP_MULTIPLIER = {
  tiers: [
    { mult: 3,  chance: 0.05  }, // ×3  ：5%概率
    { mult: 9,  chance: 0.01  }, // ×9  ：1%概率
    { mult: 27, chance: 0.002 }, // ×27 ：0.2%概率
  ],
};
...
var EVOLUTION_FOREST_CONFIG = {
  id: 'evolution_forest',
  name: '进化森林',
  desc: '探索神秘进化森林，获取进化晶石等丰厚奖励',
  dailyLimit: 50,
  minLevel: 20,
  layers: [
    { layer: 1, name: '森林入口', level: 20,  icon: '🌲', monsterName: '森林史莱姆',   hpMult: 5,  atkMult: 4,  desc: '低难度，适合新手练手' },
    { layer: 2, name: '密林深处', level: 40,  icon: '🌿', monsterName: '密林哥布林',   hpMult: 8,  atkMult: 6,  desc: '中等难度，掉落中级晶石' },
    { layer: 3, name: '古树祭坛', level: 60,  icon: '🌳', monsterName: '古树守护者',   hpMult: 12, atkMult: 9,  desc: '较高难度，必掉中级晶石' },
    { layer: 4, name: '深渊沼泽', level: 80,  icon: '🌫️', monsterName: '深渊巨兽',     hpMult: 18, atkMult: 14, desc: '高难度，概率掉落高级晶石' },
    { layer: 5, name: '世界之树', level: 100, icon: '🌲', monsterName: '世界树之灵',   hpMult: 28, atkMult: 22, desc: '最高难度，必掉高级晶石' },
  ],
  // 奖励配置：按层数配置进化晶石掉落
  rewards: [
    // layer 1: 低级晶石×2~4, 10%概率中级晶石×1
    { layer: 1, crystalLow: [2, 4], crystalMid: { chance: 0.10, count: 1 }, crystalHigh: null, gold: [500, 1500], exp: [200, 500] },
    // layer 2: 低级晶石×3~6, 30%概率中级晶石×1
    { layer: 2, crystalLow: [3, 6], crystalMid: { chance: 0.30, count: 1 }, crystalHigh: null, gold: [1000, 3000], exp: [500, 1000] },
    // layer 3: 必掉中级晶石×1~2, 5%概率高级晶石×1
    { layer: 3, crystalLow: [5, 8], crystalMid: { chance: 1.00, count: 2 }, crystalHigh: { chance: 0.05, count: 1 }, gold: [2000, 5000], exp: [1000, 2000] },
    // layer 4: 必掉中级晶石×2~3, 20%概率高级晶石×1
    { layer: 4, crystalLow: [8, 12], crystalMid: { chance: 1.00, count: 3 }, crystalHigh: { chance: 0.20, count: 1 }, gold: [4000, 8000], exp: [2000, 4000] },
    // layer 5: 必掉高级晶石×1~2, 50%概率额外高级×1
    { layer: 5, crystalLow: [10, 15], crystalMid: { chance: 1.00, count: 5 }, crystalHigh: { chance: 0.80, count: 2 }, gold: [8000, 15000], exp: [4000, 8000] },
  ],
};
...
// 低级打造消耗 2低水晶+1低符文，分解优秀仅1低水晶，分解稀有1~2低水晶+0~1低符文（期望回收<消耗）
const PET_EQUIP_DECOMP_YIELD = {
uncommon: { mystic_crystal_low: [1, 1] },
rare:   { mystic_crystal_low: [1, 2], ancient_rune_low: [0, 1] },
epic:   { mystic_crystal_mid: [2, 3], ancient_rune_mid: [1, 1] },
legend: { mystic_crystal_high: [3, 4], ancient_rune_high: [1, 2] },
  mythic: { mystic_crystal_high: [4, 6], ancient_rune_high: [2, 3] },
};
...
const RUNE_CYCLE_CONFIG = {
  dailyLimit: 3,
  minLevel: 50,
  // 战力档位奖励：[战力下限, 低级符文, 中级符文, 高级符文, 成品符文掉率]
  tiers: [
    { cpMin: 0,       runeLow: 3, runeMid: 0, runeHigh: 0, runeDropRate: 0.10 },
    { cpMin: 50000,   runeLow: 2, runeMid: 2, runeHigh: 0, runeDropRate: 0.12 },
    { cpMin: 150000,  runeLow: 1, runeMid: 3, runeHigh: 1, runeDropRate: 0.15 },
    { cpMin: 300000,  runeLow: 0, runeMid: 4, runeHigh: 2, runeDropRate: 0.18 },
    { cpMin: 600000,  runeLow: 0, runeMid: 2, runeHigh: 4, runeDropRate: 0.22 },
    { cpMin: 1000000, runeLow: 0, runeMid: 0, runeHigh: 6, runeDropRate: 0.25 },
  ],
};
...
dig:             55,   // 挖密藏
pet_equip:       50,   // 宠物装备（含符文系统，从60级下调至50级）
  pet_cave:        60,   // 宠物秘境
...
const ITEM_CONFIG = {
  ...
  yuanxiao_int:     { name:'智力元宵', desc:'提升宠物智力资质10~30', tier:3, valueLevel:'B', dropWeight:3, tradeable:true, decomposable:false, refinable:false, stackMax:99, shopPrice:2500, currency:'gold', sources:['商城','藏宝图'] },
  // [已移除] 进阶丸道具定义已删除
  // ===== 进阶系统道具（进化晶石） =====
  evolution_crystal_low:  { name:'低级进化晶石', desc:'宠物进阶材料，提供15点进阶值，低概率触发暴击', tier:2, valueLevel:'C', dropWeight:6, tradeable:true, decomposable:false, refinable:false, stackMax:999, shopPrice:500, currency:'gold', sources:['进化森林','商城'] },
  evolution_crystal_mid:  { name:'中级进化晶石', desc:'宠物进阶材料，提供50点进阶值，低概率触发暴击', tier:4, valueLevel:'A', dropWeight:3, tradeable:true, decomposable:false, refinable:false, stackMax:999, shopPrice:3000, currency:'gold', sources:['进化森林','商城'] },
  evolution_crystal_high: { name:'高级进化晶石', desc:'宠物进阶材料，提供150点进阶值，低概率触发暴击', tier:5, valueLevel:'S', dropWeight:1, tradeable:true, decomposable:false, refinable:false, stackMax:999, shopPrice:20, currency:'diamond', sources:['进化森林','商城'] },
  ...
  // ===== 挖秘藏道具 =====
  dig_map:          { name:'密藏图', desc:'使用后开启挖秘藏九宫格玩法', tier:3, valueLevel:'B', dropWeight:5, tradeable:true, decomposable:false, refinable:false, stackMax:99, shopPrice:1500, currency:'gold', sources:['商城','藏宝图','副本掉落'] },
  ...
  ancient_rune_low:    { name:'低级远古符文', desc:'宠物装备打造材料', tier:2, valueLevel:'C', dropWeight:8, tradeable:false, decomposable:false, refinable:false, stackMax:999, shopPrice:null, sources:['宠物秘境','宠物装备分解'] },
  ancient_rune_mid:    { name:'中级远古符文', desc:'宠物装备打造材料', tier:3, valueLevel:'B', dropWeight:4, tradeable:false, decomposable:false, refinable:false, stackMax:999, shopPrice:null, sources:['宠物秘境','宠物装备分解'] },
  ancient_rune_high:   { name:'高级远古符文', desc:'宠物装备打造材料', tier:5, valueLevel:'S', dropWeight:1, tradeable:false, decomposable:false, refinable:false, stackMax:999, shopPrice:null, sources:['宠物秘境','宠物装备分解'] },
};
...
// ===== 符文位置（1-6）及主属性类型 =====
// 位置1: 攻击力(固定值)  位置2: 速度(固定值)  位置3: 防御力(固定值)
// 位置4: 气血%(百分比)   位置5: 气血(固定值)  位置6: 暴击率/暴击伤害(百分比)
const RUNE_SLOTS = [
  { id: 1, name: '一号位', icon: '⚔️', mainStatType: 'atk_flat', mainStatName: '攻击力' },
  { id: 2, name: '二号位', icon: '💨', mainStatType: 'spd_flat', mainStatName: '速度' },
  { id: 3, name: '三号位', icon: '🛡️', mainStatType: 'def_flat', mainStatName: '防御力' },
  { id: 4, name: '四号位', icon: '❤️', mainStatType: 'hp_pct', mainStatName: '气血%' },
  { id: 5, name: '五号位', icon: '💖', mainStatType: 'hp_flat', mainStatName: '气血' },
  { id: 6, name: '六号位', icon: '🎯', mainStatType: 'crit_rate', mainStatName: '暴击率' },
];
...
// 计算符文主属性数值
function calcRuneMainStat(statType, gradeIdx, level) {
  var base = RUNE_MAIN_STAT_BASE[statType] || 10;
  var val = base * (1 + gradeIdx * 0.3) * (1 + level * 0.10);
  // 百分比类保留3位小数，固定值取整
  if (statType.indexOf('pct') >= 0 || statType === 'crit_rate' || statType === 'crit_dmg') {
...
var RUNE_SUB_STAT_INCREMENT = {
  atk_flat: 3, def_flat: 2, hp_flat: 20, spd_flat: 2,
  atk_pct: 0.01, def_pct: 0.01, hp_pct: 0.01,
  crit_rate: 0.01, crit_dmg: 0.02, int_flat: 3,
};
